              ...
              <FormItem className="w-full">
                <FormControl>
                  <Input
                    ...
                    {...field}
                    className="bg-gray-100 h-[54px] focus-visible:ring-offset-0 placeholder:text-grey-500 rounded-2xl p-regular-16 px-4 py-3 border-none focus-visible:ring-transparent"
                  />
                </FormControl>
                <FormMessage />
              </FormItem>
              ...
              <FormItem className="w-full">
                <FormControl className="h-72">
                  <Textarea
                    ...
                    {...field}
                    className="bg-gray-100 flex flex-1 placeholder:text-grey-500 p-regular-16 px-5 py-3 border-none focus-visible:ring-transparent rounded-2xl"
                  />
                </FormControl>
                <FormMessage />
              </FormItem>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="w-full">
                <FormControl>
                  <div className="flex-center h-[55px] w-full overflow-hidden rounded-full bg-gray-100 px-4 py-2">
                    <CircleDollarSign height={24} width={24} />
                    <Input
                      type="number"
                      placeholder="Price"
                      {...field}
